...
import com.crystalKeyHotels.pages.AO_US_005Page;
...
public class AO_US_005PositiveSenaryo {
    ...
    public void test() throws InterruptedException {
        ...
        Assert.assertEquals(ao_us_005Page.ck_success.getText(),"HotelRoom was inserted successfully");
        // SoftAssert softAssert=new SoftAssert();
        // softAssert.assertTrue(crsytalKeyHotelPage.ck_success.getText().contains(ConfigReader.getProperty("ck_successfully")));
