...
public class AO_US_005NegativeSenaryo01 {

    @Test
    public void HotelSecimiYapilmamasi() throws InterruptedException {
        ...
        Assert.assertEquals(ao_us_005Page.HataMesaji.getText(),"Select Hotel");
