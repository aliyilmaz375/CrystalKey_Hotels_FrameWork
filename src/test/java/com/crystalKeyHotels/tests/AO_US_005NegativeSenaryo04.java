...
public class AO_US_005NegativeSenaryo04 {

    @Test
    public void adresButonuBosBirakilmali() throws InterruptedException {
        ...
        Assert.assertEquals(ao_us_005Page.HataMesaji.getText(),"Location");
