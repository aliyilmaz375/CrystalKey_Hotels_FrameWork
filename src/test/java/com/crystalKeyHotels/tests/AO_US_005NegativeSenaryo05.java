...
public class AO_US_005NegativeSenaryo05 {
    ...
    public void codeButonuBosBirakilmasi() throws InterruptedException {
        ...
        //actions.dragAndDrop(us_005Page.ck_dortyuzbuton,us_005Page.ck_priceTextBoxButton).perform();
        ...
        Assert.assertEquals(ao_us_005Page.HataMesaji.getText(),"Price");
